...
+formlogin.DelQ(edZaglav.Text)+'; Формулировка: '+formlogin.DelQ(memTask.Lines.Text)+'; Назначивший: '+
edMaster.Text+'; Дата начала: '+formatdatetime('yyy-mm-dd',MyQuery1.FieldValues['Data_sozd'])+'; Дата выполнения: '+
formatdatetime('yyy-mm-dd',dtVupol.Date)+'; Комментарий: '+formlogin.DelQ(memComment.Lines.Text)+chr(39)+', NOW());';
MyQuery1.Close;
MyQuery1.SQL.Clear;
MyQuery1.SQL.Add(S);
MyQuery1.ExecSQL;
...
+edZaglav.Text+'; Формулировка: '+formlogin.DelQ(memTask.Lines.Text)+'; Назначена на: '+
edMaster.Text+'; Дата начала: '+formatdatetime('yyy-mm-dd',MyQuery1.FieldValues['Data_sozd'])+'; Дата выполнения: '+
formatdatetime('yyy-mm-dd',dtVupol.Date)+'; Комментарий: '+formlogin.DelQ(memComment.Lines.Text)+chr(39)+', NOW());';
MyQuery1.Close;
MyQuery1.SQL.Clear;
...
+edZaglav.Text+'; Формулировка: '+formlogin.DelQ(memTask.Lines.Text)+'; Назначивший: '+
edMaster.Text+'; Дата начала: '+formatdatetime('yyy-mm-dd',MyQuery1.FieldValues['Data_sozd'])+'; Дата выполнения: '+
formatdatetime('yyy-mm-dd',dtVupol.Date)+'; Комментарий: '+formlogin.DelQ(memComment.Lines.Text)+chr(39)+', NOW());';
MyQuery1.Close;
MyQuery1.SQL.Clear;
...
if MasterRole then
  ...
  memTask.Enabled:=false;      //Не давать редактировать работу мастерам
  end;
